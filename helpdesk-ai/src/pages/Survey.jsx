  ...
  return (
    <div className="min-h-screen bg-[#09090b] flex flex-col items-center justify-center px-4 text-center relative overflow-hidden">
      ...
      <div className="relative z-20 w-full max-w-md">
        ...
        <p className="text-[14px] text-[#a1a1aa] max-w-sm mx-auto mb-1 leading-relaxed">
        ...
        {/* ── Share nudge card ── */}
        <div className="mb-8 p-5 bg-[#18181b] border border-[#3b82f6]/20 rounded-2xl text-left">
          <div className="flex items-center gap-2 mb-2">
            <span className="text-lg">🙏</span>
            <p className="text-[13px] font-semibold text-[#fafafa]">Help us reach more people</p>
          </div>
          ...
          <div className="flex items-center gap-2">
            <span className="text-[10px] text-[#3f3f46] flex-shrink-0">Share via:</span>
            <a href={`https://wa.me/?text=${encodeURIComponent(`Hey! I just filled in a quick survey for HiTicket — an AI-powered IT helpdesk. Would love your thoughts too 👇\n${surveyUrl}`)}`}
